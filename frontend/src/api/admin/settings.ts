...
export interface SystemSettings {
  ...
  llm_monitor_provider_url: string;
  home_content: string;
  ...
  upstream_management_login_url: string;
  upstream_management_model_url: string;
  upstream_management_model_square_url?: string;
  upstream_management_api_keys_url: string;
  upstream_management_groups_url: string;
