...
function methodSelectedClass(type: string): string {
  ...
  if (type === 'airwallex') return 'border-[#FF6B3D] bg-orange-50 text-gray-900 shadow-sm ring-1 ring-[#FF6B3D]/15 dark:border-[#FF8E3C] dark:bg-orange-950/60 dark:text-gray-100'
