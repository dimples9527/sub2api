...
.dark .po-kpi-default .po-kpi-label {
  color: #5eead4;
}
...
.dark .po-kpi-warning .po-kpi-label {
  color: #fcd34d;
}
...
.dark .po-kpi-success .po-kpi-label {
  color: #6ee7b7;
}
