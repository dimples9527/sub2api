export default {
    ...
    subscriptions: {
      ...
      manualResetConfirm: "确定要按结算金额扣减 '{user}' 的每日、每周和每月已用额度吗？",
      quotaResetSuccess: '配额重置成功',
      failedToResetQuota: '重置配额失败',
      resettingQuota: '重置中...',
      manualResetAmount: '手动结算额度（美元）',
      manualResetAmountPlaceholder: '留空则全部归零',
      manualResetAmountHint: '填写客户本次已结算的金额，系统会从日、周、月已用额度中分别扣减；留空则将三项全部归零。',
      currentUsage: '当前已用：日 ${daily}，周 ${weekly}，月 ${monthly}',
      invalidResetAmount: '请输入大于 0 的有效额度。',
