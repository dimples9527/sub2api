export default {
  ...
  usage: {
    ...
    latencyBreakdownEmpty: '该请求没有采集到耗时分解',
    latencyBreakdownFailed: '耗时分解加载失败',
    latencyBreakdownHint: '分解只覆盖最终成功的那次上游请求；本地开销大说明卡在连接池排队或建连，等上游首字大说明慢在上游。',
    latencyPhaseBuild: '组装请求',
    latencyPhaseSlotWait: '等连接空位',
    latencyPhaseConnect: '建连 (DNS+TCP)',
    latencyPhaseTls: 'TLS 握手',
    latencyPhaseFirstByte: '等上游首字节',
    latencyPhaseOther: '其他（未归类）',
    latencyPhaseStream: '流式传输',
    latencyLocalOverhead: '本地开销',
    latencyUpstreamWait: '上游等待',
    latencyConnReused: '复用连接',
    latencyConnNew: '新建连接',
    time: '时间',
    ws: 'WS',
    stream: '流式',
