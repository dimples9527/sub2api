export default {
  ...
  auth: {
    ...
    invitationLimitReached: '\u8be5\u9080\u8bf7\u4eba\u7684\u53ef\u9080\u8bf7\u4eba\u6570\u5df2\u8fbe\u4e0a\u9650',
  ...
  admin: {
    ...
    settings: {
      ...
      modelSquare: {
        title: '模型广场配置',
        description: '配置后台代理登录 findcg 所需的地址和账号，前端不会暴露密码。',
        baseUrl: '服务地址',
        email: '登录邮箱',
        password: '登录密码',
        passwordPlaceholder: '输入 findcg 登录密码',
      ...
      registration: {
        ...
        invitationLimit: '\u9080\u8bf7\u4eba\u6570\u9650\u5236',
        invitationLimitPlaceholder: '0',
        invitationLimitHint: '\u6bcf\u4e2a\u9080\u8bf7\u4eba\u6700\u591a\u53ef\u9080\u8bf7\u7684\u7528\u6237\u6570\uff0c0 \u8868\u793a\u4e0d\u9650\u5236',
        passwordReset: '忘记密码',
      ...
      site: {
        ...
        globalBannerMessage: '跑马灯文案',
        globalBannerMessagePlaceholder: '请输入页面顶部跑马灯展示的文字',
        globalBannerMessageHint: '显示在页面顶部滚动横幅中，留空则不显示。',
        apiBaseUrl: 'API 端点地址',
      ...
      payment: {
        ...
        rechargeOptionsPlaceholder: '例如：2, 5, 10, 20, 50',
        rechargeOptionsHint: '使用英文逗号分隔，保存时会自动去重并排序。',
        introRechargePayAmount: '首充实付金额',
        introRechargeCreditAmount: '首充到账额度',
        introRechargeHint: '到账额度大于实付金额时启用首充优惠；填 0 可关闭。',
        invalidRechargeOptions: '请输入有效的充值金额列表，使用英文逗号分隔',
        providerEasypay: '易支付',
