export default {
  ...
  usage: {
    ...
    latencyBreakdownHint: 'The breakdown covers only the upstream attempt that finally succeeded. Large local overhead means connection-pool queuing or dialing; large upstream wait means the upstream itself was slow.',
    latencyPhaseBuild: 'Build request',
    latencyPhaseSlotWait: 'Connection wait',
    latencyPhaseConnect: 'Connect (DNS+TCP)',
    latencyPhaseTls: 'TLS handshake',
    latencyPhaseFirstByte: 'Upstream first byte',
    latencyPhaseOther: 'Other (unattributed)',
    latencyPhaseStream: 'Streaming',
    latencyLocalOverhead: 'Local overhead',
    latencyUpstreamWait: 'Upstream wait',
    latencyConnReused: 'Reused connection',
    latencyConnNew: 'New connection',
    time: 'Time',
    ws: 'WS',
    stream: 'Stream',
    sync: 'Sync',
