export default {
    ...
    subscriptions: {
      ...
      manualResetConfirm: "Deduct the settled amount from the daily, weekly, and monthly usage for '{user}'?",
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      resettingQuota: 'Resetting...',
      manualResetAmount: 'Manual settled amount (USD)',
      manualResetAmountPlaceholder: 'Leave blank to reset all to zero',
      manualResetAmountHint: 'Enter the amount settled by the customer. It will be deducted from daily, weekly, and monthly usage; leave blank to zero all three.',
      currentUsage: 'Current usage: daily ${daily}, weekly ${weekly}, monthly ${monthly}',
      invalidResetAmount: 'Enter a valid amount greater than 0.',
