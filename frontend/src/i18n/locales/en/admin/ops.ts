export default {
    ops: {
      ...
      runtime: {
        ...
        slaMinPercentHint: 'SLA below this value will be highlighted in red. Default: 99.5%.',
        ttftP99MaxMs: 'TTFT P99 Maximum (ms)',
        ttftP99MaxMsHint: 'TTFT P99 above this value will be highlighted in red. Default: 500ms.',
        requestErrorRateMaxPercent: 'Request Error Rate Maximum (%)',
        requestErrorRateMaxPercentHint: 'Request error rate above this value will be highlighted in red. Default: 5%.',
        upstreamErrorRateMaxPercent: 'Upstream Error Rate Maximum (%)',
        upstreamErrorRateMaxPercentHint: 'Upstream error rate above this value will be highlighted in red. Default: 5%.',
        validation: {
          title: 'Please fix the following issues',
