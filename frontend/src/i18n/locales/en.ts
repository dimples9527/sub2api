export default {
  ...
  admin: {
    ...
    upstreamAccounts: {
      ...
      rateGuardPollLogs: 'Rate guard polling logs',
      rateGuardPollLogsDescription: 'Keeps the latest 10 in-process checks so you can confirm the scheduler is polling.',
