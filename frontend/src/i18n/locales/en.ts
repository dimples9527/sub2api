export default {
  ...
  imageGeneration: {
    navCrumb: 'IMAGE',
    title: 'Image Studio',
    description: 'Generate images with your own API Key and bill through its group',
    ...
    generatingHint: 'Image generation may take tens of seconds. Keep this page open.',
    reusePrompt: 'Reuse prompt',
    continueEdit: 'Continue edit',
    continueEditPrefix: 'Continue editing',
    retry: 'Retry',
    downloadAll: 'Download all',
    copyImageUrl: 'Copy image source',
    ...
    emptyResponse: 'The request completed but returned no image.',
    errors: {
      auth: 'Image generation authorization failed. Check whether the API Key is valid and has access.',
      quota: 'Image generation quota is insufficient. Check balance, quota, or billing status.',
      size: 'This resolution or request parameter is not supported. Adjust it and try again.',
      network: 'Network connection failed or the request timed out. Try again later.',
      groupDisabled: 'The selected API Key group has image generation disabled. Switch to an enabled group.',
    },
    qualities: {
      auto: 'Auto',
      low: 'Low',
    ...
    samples: {
      glass: 'A rainy cyberpunk street at night',
      portrait: 'A shiba inu wearing sunglasses, flat illustration',
      sunrise: 'Snow mountain sunrise, ultra-wide landscape photo',
      logo: 'Turn this concept into a watercolor style',
    },
  },
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        rechargeOptions: 'Recharge Amount Presets',
        rechargeOptionsPlaceholder: '2, 5, 10, 20, 50, 100',
        rechargeOptionsHint: 'Comma-separated amounts. Values are sorted, deduplicated, and shown on the user recharge page.',
        invalidRechargeOptions: 'Recharge amount presets must be positive numbers separated by commas',
