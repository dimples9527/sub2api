export default {
  ...
  auth: {
    ...
    invitationLimitReached: 'This inviter has reached the invitation limit',
  ...
  admin: {
    ...
    settings: {
      ...
      modelSquare: {
        ...
        description: 'Configure the backend proxy credentials for findcg. The password is never exposed to the frontend.',
        baseUrl: 'Base URL',
        email: 'Login Email',
        password: 'Login Password',
        passwordPlaceholder: 'Enter findcg login password',
      ...
      registration: {
        ...
        invitationLimitPlaceholder: '0',
        invitationLimitHint: 'Maximum invited users per inviter. 0 means no limit',
      ...
      site: {
        ...
        globalBannerMessage: 'Global Banner Message',
        globalBannerMessagePlaceholder: 'Enter the marquee message shown at the top of the page',
        globalBannerMessageHint: 'Displayed in the top scrolling banner. Leave empty to hide the banner.',
      ...
      payment: {
        ...
        rechargeOptions: 'Recharge Amounts',
        rechargeOptionsPlaceholder: 'Example: 2, 5, 10, 20, 50',
        rechargeOptionsHint: 'Comma-separated preset recharge amounts, sorted and deduplicated automatically.',
        introRechargePayAmount: 'Intro Actual Pay',
        introRechargeCreditAmount: 'Intro Credit',
        introRechargeHint: 'Set credit greater than actual pay to enable the one-time intro discount; set 0 to disable.',
        invalidRechargeOptions: 'Please enter valid recharge amounts separated by commas',
