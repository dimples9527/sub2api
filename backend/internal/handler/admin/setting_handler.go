...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		UpstreamManagementBaseURL:                         settings.UpstreamManagementBaseURL,
		UpstreamManagementLoginURL:                        settings.UpstreamManagementLoginURL,
		UpstreamManagementModelURL:                        settings.UpstreamManagementModelURL,
		UpstreamManagementAPIKeysURL:                      settings.UpstreamManagementAPIKeysURL,
		UpstreamManagementGroupsURL:                       settings.UpstreamManagementGroupsURL,
		UpstreamManagementEmail:                           settings.UpstreamManagementEmail,
		UpstreamManagementPasswordConfigured:              settings.UpstreamManagementPasswordConfigured,
		UpstreamManagementKeysSyncIntervalSeconds:         settings.UpstreamManagementKeysSyncIntervalSeconds,
		UpstreamManagementAccountRateGuardIntervalSeconds: settings.UpstreamManagementAccountRateGuardIntervalSeconds,
		UpstreamManagementProviders:                       upstreamManagementProviderDTOs(settings.UpstreamManagementProviders),
...
type UpdateSettingsRequest struct {
	...
	UpstreamManagementModelSquareURL                  string                              `json:"upstream_management_model_square_url"`
	...
	UpstreamManagementPassword                        string                              `json:"upstream_management_password"`
	...
	UpstreamManagementProviders                       []UpstreamManagementProviderRequest `json:"upstream_management_providers"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		UpstreamManagementBaseURL:                         firstNonEmpty(req.UpstreamManagementBaseURL, req.ModelSquareBaseURL),
		UpstreamManagementLoginURL:                        firstNonEmpty(req.UpstreamManagementLoginURL, req.ModelSquareLoginURL),
		UpstreamManagementModelURL:                        firstNonEmpty(req.UpstreamManagementModelURL, req.UpstreamManagementModelSquareURL, req.ModelSquareModelURL),
		UpstreamManagementAPIKeysURL:                      firstNonEmpty(req.UpstreamManagementAPIKeysURL, req.ModelSquareKeysURL),
		UpstreamManagementGroupsURL:                       firstNonEmpty(req.UpstreamManagementGroupsURL, req.ModelSquareGroupsURL),
		UpstreamManagementEmail:                           firstNonEmpty(req.UpstreamManagementEmail, req.ModelSquareEmail),
		UpstreamManagementPassword:                        firstNonEmpty(req.UpstreamManagementPassword, req.ModelSquarePassword),
		UpstreamManagementKeysSyncIntervalSeconds:         firstPositiveInt(req.UpstreamManagementKeysSyncIntervalSeconds, req.ModelSquareKeysSyncIntervalSeconds),
		UpstreamManagementAccountRateGuardIntervalSeconds: req.UpstreamManagementAccountRateGuardIntervalSeconds,
		UpstreamManagementProviders: func() []service.UpstreamManagementProviderSetting {
			if req.UpstreamManagementProviders != nil {
				return upstreamManagementProviderSettingsFromRequest(req.UpstreamManagementProviders)
			}
			return previousSettings.UpstreamManagementProviders
		}(),
	...
	payload := dto.SystemSettings{
		...
		UpstreamManagementBaseURL:                         updatedSettings.UpstreamManagementBaseURL,
		UpstreamManagementLoginURL:                        updatedSettings.UpstreamManagementLoginURL,
		UpstreamManagementModelURL:                        updatedSettings.UpstreamManagementModelURL,
		UpstreamManagementAPIKeysURL:                      updatedSettings.UpstreamManagementAPIKeysURL,
		UpstreamManagementGroupsURL:                       updatedSettings.UpstreamManagementGroupsURL,
		UpstreamManagementEmail:                           updatedSettings.UpstreamManagementEmail,
		UpstreamManagementPasswordConfigured:              updatedSettings.UpstreamManagementPasswordConfigured,
		UpstreamManagementKeysSyncIntervalSeconds:         updatedSettings.UpstreamManagementKeysSyncIntervalSeconds,
		UpstreamManagementAccountRateGuardIntervalSeconds: updatedSettings.UpstreamManagementAccountRateGuardIntervalSeconds,
		UpstreamManagementProviders:                       upstreamManagementProviderDTOs(updatedSettings.UpstreamManagementProviders),
...
func upstreamManagementProviderDTOs(providers []service.UpstreamManagementProviderSetting) []dto.UpstreamManagementProviderSetting {
	if len(providers) == 0 {
		return []dto.UpstreamManagementProviderSetting{}
	}
...
func upstreamManagementProviderSettingsFromRequest(providers []UpstreamManagementProviderRequest) []service.UpstreamManagementProviderSetting {
	if len(providers) == 0 {
		return []service.UpstreamManagementProviderSetting{}
	}
