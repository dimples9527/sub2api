...
const (
	...
	SettingKeyInvitationLimit                  = "invitation_limit"                    // 单个邀请码使用限制，0 表示不限制
	...
	SettingKeyUpstreamManagementBaseURL                         = "upstream_management_base_url"
	SettingKeyUpstreamManagementLoginURL                        = "upstream_management_login_url"
	SettingKeyUpstreamManagementModelURL                        = "upstream_management_model_url"
	SettingKeyUpstreamManagementModelSquareURL                  = "upstream_management_model_square_url"
	SettingKeyUpstreamManagementAPIKeysURL                      = "upstream_management_api_keys_url"
	SettingKeyUpstreamManagementGroupsURL                       = "upstream_management_groups_url"
	SettingKeyUpstreamManagementEmail                           = "upstream_management_email"
	SettingKeyUpstreamManagementPassword                        = "upstream_management_password"
	SettingKeyUpstreamManagementKeysSyncIntervalSeconds         = "upstream_management_keys_sync_interval_seconds"
	SettingKeyUpstreamManagementAccountRateGuardIntervalSeconds = "upstream_management_account_rate_guard_interval_seconds"
	SettingKeyUpstreamManagementProviders                       = "upstream_management_providers"
