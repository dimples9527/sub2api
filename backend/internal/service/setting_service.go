...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	updates[SettingKeyGlobalBannerMessage] = settings.GlobalBannerMessage
	updates[SettingKeyAPIBaseURL] = settings.APIBaseURL
	updates[SettingKeyContactInfo] = settings.ContactInfo
	updates[SettingKeyDocURL] = settings.DocURL
	updates[SettingKeyLLMMonitorStatusAPIURL] = settings.LLMMonitorStatusAPIURL
	updates[SettingKeyLLMMonitorTitle] = settings.LLMMonitorTitle
	updates[SettingKeyLLMMonitorProviderURL] = settings.LLMMonitorProviderURL
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result := &SystemSettings{
		...
		ContactInfo:                      settings[SettingKeyContactInfo],
		DocURL:                           settings[SettingKeyDocURL],
		LLMMonitorStatusAPIURL:           settings[SettingKeyLLMMonitorStatusAPIURL],
		LLMMonitorTitle:                  settings[SettingKeyLLMMonitorTitle],
		LLMMonitorProviderURL:            settings[SettingKeyLLMMonitorProviderURL],
		HomeContent:                      settings[SettingKeyHomeContent],
		HideCcsImportButton:              settings[SettingKeyHideCcsImportButton] == "true",
		PurchaseSubscriptionEnabled:      settings[SettingKeyPurchaseSubscriptionEnabled] == "true",
		PurchaseSubscriptionURL:          strings.TrimSpace(settings[SettingKeyPurchaseSubscriptionURL]),
