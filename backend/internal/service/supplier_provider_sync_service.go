...
type SupplierProviderAccount struct {
	...
	LocalAccountLastTestLatencyMs        int64                                 `json:"local_account_last_test_latency_ms,omitempty"`
	...
	SupplierEstimatedDays                *float64                              `json:"supplier_estimated_days,omitempty"`
