...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	supplierAccountHealthGuardService := service.NewSupplierAccountHealthGuardService(supplierAccountHealthGuardRepository, supplierAccountHealthGuardAccountStore, supplierAccountHealthGuardTester)
