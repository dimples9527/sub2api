...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	supplierAutomationService := service.ProvideSupplierAutomationService(supplierAutomationRepository, supplierAutomationRedisLock, supplierProviderSyncService, supplierProviderDataRepository, supplierRateGuardService)
