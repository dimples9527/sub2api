...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	supplierProviderSyncService := service.NewSupplierProviderSyncService(supplierProviderRepository, supplierProviderDataRepository, supplierProviderRemoteClient, secretEncryptor, supplierProviderTokenCache)
