...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	supplierProviderSyncService := service.ProvideSupplierProviderSyncService(supplierProviderRepository, supplierProviderDataRepository, supplierProviderRechargeRepository, supplierProviderRemoteRegistry, secretEncryptor, supplierProviderTokenRedisCache, supplierProviderGroupMatcher, supplierCostDeviationSettingsService)
