...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	supplierProviderService := service.ProvideSupplierProviderService(supplierProviderRepository, secretEncryptor, supplierProviderTypeRepository, supplierProviderTokenRedisCache)
