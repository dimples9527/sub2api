...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	upstreamAccountHealthGuardRecordRepository := repository.NewUpstreamAccountHealthGuardRecordRepository(db)
	...
	supplierProviderRemoteClient := service.ProvideSupplierProviderRemoteClient(supplierProviderTokenCache)
	supplierProviderGroupMatcher := service.ProvideSupplierProviderGroupMatcher(supplierProviderDataRepository, groupRepository)
	supplierProviderSyncService := service.ProvideSupplierProviderSyncService(supplierProviderRepository, supplierProviderDataRepository, supplierProviderRemoteClient, secretEncryptor, supplierProviderTokenCache, supplierProviderGroupMatcher)
	...
	supplierProviderSyncHandler := handler.ProvideSupplierProviderSyncHandler(supplierProviderSyncService, supplierProviderDataRepository, supplierProviderGroupMatcher)
