...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	supplierProviderSyncHandler := handler.ProvideSupplierProviderSyncHandler(supplierProviderSyncService, supplierProviderDataRepository, supplierProviderGroupMatcher, supplierGroupGuardReconciler)
