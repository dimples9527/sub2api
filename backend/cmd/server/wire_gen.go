...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	supplierProviderSyncService := service.ProvideSupplierProviderSyncService(supplierProviderRepository, supplierProviderDataRepository, supplierProviderRemoteRegistry, secretEncryptor, supplierProviderTokenRedisCache, supplierProviderGroupMatcher, supplierCostDeviationSettingsService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, customPlatformHandler, accountHandler, customPlatformService, monitorGroupPlatformOverrideService, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, supplierProviderHandler, supplierProviderAuthHandler, supplierProviderTypeHandler, supplierProviderSyncHandler, supplierAutomationHandler, supplierDashboardHandler, supplierBalanceAlertHandler, supplierNotificationHandler, supplierCostDeviationSettingsHandler, upstreamProviderHandler, upstreamDashboardHandler, upstreamManagementHandler, upstreamAccountSyncHandler, ollamaCloudUsageService)
